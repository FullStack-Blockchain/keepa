...
<ul class="navbar-nav align-items-center d-none d-lg-block">
  <li class="nav-item">
    <div class="search-box" data-list='{"valueNames":["title"]}'>
      <form class="position-relative" data-bs-toggle="search" data-bs-display="static" method = "post">
        <input class="form-control search-input fuzzy-search" id="search_term" name="search_term" type="search" placeholder="ASIN、JAN、キーワード" aria-label="Search" />
