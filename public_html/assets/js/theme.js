...
var chartRanking = function chartRanking() {
  var ECHART_RANKING = '.echart-line-ranking';
  var $echartsRanking = document.querySelector(ECHART_RANKING);
  ...
  if ($echartsRanking) {
    // Get options from data attribute
    var userOptions = utils.getData($echartsRanking, 'options');

    var SELECT_MONTH = "#".concat(userOptions.selectMonth);
    var monthSelect = document.querySelector(SELECT_MONTH);
    monthSelect = monthSelect.value;

    var chart = window.echarts.init($echartsRanking);
    ...
    var getDefaultOptions = function getDefaultOptions() {
      return {
        ...
        series: [{
          type: 'line',
          data: ranking_chart[monthSelect],
          lineStyle: {
            color: utils.getColors().primary
          },
          itemStyle: {
...
var leaferUser = function leaferUser() {
  var ECHART_LINE_LEAFER_USER = '.echart-line-leafer-user';
  var $echartsLineLeaferUser = document.querySelector(ECHART_LINE_LEAFER_USER);
  var months = ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'];
  ...
  if ($echartsLineLeaferUser) {
    // Get options from data attribute
    var userOptions = utils.getData($echartsLineLeaferUser, 'options');

    var SELECT_MONTH = "#".concat(userOptions.selectMonth);
    var monthSelect = document.querySelector(SELECT_MONTH);
    monthSelect = monthSelect.value;

    var chart = window.echarts.init($echartsLineLeaferUser);
    // var monthsnumber = $leafer_user_date[monthSelect];
    ...
    var getDefaultOptions = function getDefaultOptions() {
      return {
        ...
        series: [{
          type: 'line',
          data: $leafer_user_chart[monthSelect],
          lineStyle: {
            color: utils.getColors().primary
          },
          itemStyle: {
...
var numberOfSellers = function numberOfSellers() {
  var ECHART_LINE_NUMBER_OF_SELLERS = '.echart-line-number-of-sellers';
  var $echartsLineNumberOfSellers = document.querySelector(ECHART_LINE_NUMBER_OF_SELLERS);
  var months = ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'];
  ...
  function getFormatter(params) {
    return params.map(function (_ref16, index) {
      var value = _ref16.value,
          borderColor = _ref16.borderColor;
      return "<span class= \"fas fa-circle\" style=\"color: ".concat(borderColor, "\"></span>\n    <span class='text-600'>").concat(index === 0 ? '新品出品者数' : '中古出品者数', ": ").concat(value, "</span>");
    }).join('<br/>');
  }

  if ($echartsLineNumberOfSellers) {
    // Get options from data attribute
    var userOptions = utils.getData($echartsLineNumberOfSellers, 'options');

    var SELECT_MONTH = "#".concat(userOptions.selectMonth);
    var NEW_NUMBER_OF_SELLERS = "#".concat(userOptions.optionOne);
    var USED_NUMBER_OF_SELLERS = "#".concat(userOptions.optionTwo);

    var monthSelect = document.querySelector(SELECT_MONTH);
    monthSelect = monthSelect.value;

    var newNumberOfSellers = document.querySelector(NEW_NUMBER_OF_SELLERS);
    var usedNumberOfSellers = document.querySelector(USED_NUMBER_OF_SELLERS);
    var chart = window.echarts.init($echartsLineNumberOfSellers);
    ...
    var getDefaultOptions = function getDefaultOptions() {
      return {
        ...
        series: [{
          ...
          type: 'line',
          data:
            number_of_sellers_new[monthSelect]
          ,
          lineStyle: {
            color: utils.getColor('primary')
          },
          ...
          type: 'line',
          data:
            number_of_sellers_used[monthSelect]
          ,
          lineStyle: {
            color: utils.rgbaColor(utils.getColor('warning'), 0.3)
          },
    ...
    echartSetOption(chart, userOptions, getDefaultOptions);
    newNumberOfSellers.addEventListener('click', function () {
      chart.dispatchAction({
        type: 'legendToggleSelect',
        name: 'lastMonth'
      });
    });
    usedNumberOfSellers.addEventListener('click', function () {
      chart.dispatchAction({
        type: 'legendToggleSelect',
        name: 'previousYear'
      });
...
var lowestPrice = function lowestPrice() {
  var ECHART_LINE_LOWEST_PRICE = '.echart-line-lowest-price';
  var $echartsLineLowestPrice = document.querySelector(ECHART_LINE_LOWEST_PRICE);
  var months = ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'];
  ...
  function getFormatter(params) {
    return params.map(function (_ref16, index) {
      var value = _ref16.value,
          borderColor = _ref16.borderColor;
      return "<span class= \"fas fa-circle\" style=\"color: ".concat(borderColor, "\"></span>\n    <span class='text-600'>")
        .concat(index === 0 ? 'カート価格' : (index === 1 ? '新品最安値' : (index === 2 ? '中古最安値' : 'Amazon本体価格')), ": ").concat(value, "</span>");
    }).join('<br/>');
  }

  if ($echartsLineLowestPrice) {
    // Get options from data attribute
    var userOptions = utils.getData($echartsLineLowestPrice, 'options');

    var SELECT_MONTH = "#".concat(userOptions.selectMonth);
    var CART_PRICE = "#".concat(userOptions.optionOne);
    var NEW_LOWEST_PRICE = "#".concat(userOptions.optionTwo);
    var USED_LOWEST_PRICE = "#".concat(userOptions.optionTree);
    var AMAZON_PRICE = "#".concat(userOptions.optionFour);

    var monthSelect = document.querySelector(SELECT_MONTH);
    monthSelect = monthSelect.value;

    var cartPrice = document.querySelector(CART_PRICE);

    var newLowestPrice = document.querySelector(NEW_LOWEST_PRICE);
    var usedLowestPrice = document.querySelector(USED_LOWEST_PRICE);
    var amazonPrice = document.querySelector(AMAZON_PRICE);

    var chart = window.echarts.init($echartsLineLowestPrice);
    ...
    var getDefaultOptions = function getDefaultOptions() {
      return {
        ...
        series: [{
          ...
          type: 'line',
          data:
            lowest_price_cart_price[monthSelect]
          ,
          lineStyle: {
            color: utils.getColor('primary')
          },
          ...
          type: 'line',
          data:
            lowest_price_new_price[monthSelect]
          ,
          lineStyle: {
          ...
          {
          name: 'userdLowestPrice',
          type: 'line',
          data:
            lowest_price_used_price[monthSelect]
          ,
          lineStyle: {
          ...
          type: 'line',
          data:
            lowest_price_amazon_price[monthSelect]
          ,
          lineStyle: {
            color: utils.rgbaColor(utils.getColor('warning'), 0.3)
          },
    ...
    newLowestPrice.addEventListener('click', function () {
      chart.dispatchAction({
        type: 'legendToggleSelect',
        name: 'previousYear'
      });
    });
    usedLowestPrice.addEventListener('click', function () {
      chart.dispatchAction({
        type: 'legendToggleSelect',
        name: 'userdLowestPrice'
      });
    });
    amazonPrice.addEventListener('click', function () {
      chart.dispatchAction({
        type: 'legendToggleSelect',
        name: 'amazonPrice'
      });
...
var usedPrice = function usedPrice() {
  var ECHART_LINE_USED_PRICE = '.echart-line-used-price';
  var $echartsLineUsedPrice = document.querySelector(ECHART_LINE_USED_PRICE);
  var months = ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'];
  ...
  function getFormatter(params) {
    return params.map(function (_ref16, index) {
      var value = _ref16.value,
          borderColor = _ref16.borderColor;
      return "<span class= \"fas fa-circle\" style=\"color: ".concat(borderColor, "\"></span>\n    <span class='text-600'>")
        .concat(index === 0 ? 'ほぼ新品' : (index === 1 ? '非常に良い' : (index === 2 ? '良い' : '可')), ": ").concat(value, "</span>");
    }).join('<br/>');
  }

  if ($echartsLineUsedPrice) {
    // Get options from data attribute
    var userOptions = utils.getData($echartsLineUsedPrice, 'options');

    var SELECT_MONTH = "#".concat(userOptions.selectMonth);
    var BRAND_NEW = "#".concat(userOptions.optionOne);
    var VERY_GOOD = "#".concat(userOptions.optionTwo);
    var GOOD_CONDITION = "#".concat(userOptions.optionTree);
    var POSSIBLE_CONDITION = "#".concat(userOptions.optionFour);

    var monthSelect = document.querySelector(SELECT_MONTH);
    monthSelect = monthSelect.value;

    var brandNew = document.querySelector(BRAND_NEW);
    var veryGood = document.querySelector(VERY_GOOD);
    var goodCondition = document.querySelector(GOOD_CONDITION);
    var possibleCondition = document.querySelector(POSSIBLE_CONDITION);

    var chart = window.echarts.init($echartsLineUsedPrice);
    ...
    var getDefaultOptions = function getDefaultOptions() {
      return {
        ...
        series: [{
          ...
          type: 'line',
          data:
            used_price_brand_new[monthSelect]
          ,
          lineStyle: {
            color: utils.getColor('primary')
          },
          ...
          type: 'line',
          data:
            used_price_very_good[monthSelect]
          ,
          lineStyle: {
            color: utils.rgbaColor(utils.getColor('success'), 0.3)
          },
          ...
          type: 'line',
          data:
            used_price_good_condition[monthSelect]
          ,
          lineStyle: {
            color: utils.rgbaColor(utils.getColor('danger'), 0.3)
          },
          ...
          type: 'line',
          data:
            used_price_possible_condition[monthSelect]
          ,
          lineStyle: {
            color: utils.rgbaColor(utils.getColor('warning'), 0.3)
          },
    ...
    goodCondition.addEventListener('click', function () {
      chart.dispatchAction({
        type: 'legendToggleSelect',
        name: 'userdLowestPrice'
      });
    });
    possibleCondition.addEventListener('click', function () {
      chart.dispatchAction({
        type: 'legendToggleSelect',
        name: 'amazonPrice'
      });
